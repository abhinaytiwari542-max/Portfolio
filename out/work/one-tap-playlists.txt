...
8:C
4:[["$","$Le",null,{}],["$","header",null,{"className":"fixed inset-x-0 top-0 z-40 border-b border-ink-800 bg-ink-950/80 backdrop-blur-xl","children":["$","div",null,{"className":"mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10","children":[["$","a",null,{"href":"/","className":"group inline-flex items-center gap-2 text-sm text-ink-400 hover:text-ink-50","children":[["$","svg",null,{"ref":"$undefined","xmlns":"http://www.w3.org/2000/svg","width":15,"height":15,"fill":"currentColor","viewBox":"0 0 256 256","transform":"$undefined","className":"transition-transform group-hover:-translate-x-1","children":[false,"$undefined",["$","path",null,{"d":"M228,128a12,12,0,0,1-12,12H69l51.52,51.51a12,12,0,0,1-17,17l-72-72a12,12,0,0,1,0-17l72-72a12,12,0,0,1,17,17L69,116H216A12,12,0,0,1,228,128Z"}]]}],"All work"]}],["$","a",null,{"href":"/#top","className":"flex items-center gap-2.5 text-sm font-medium tracking-tight","children":[["$","$Lf",null,{}]," Abhinay Tiwari"]}]]}]}],["$","main",null,{"children":[["$","section",null,{"className":"border-b border-ink-850 pt-36 pb-14","children":["$","div",null,{"className":"mx-auto w-full max-w-7xl px-6 lg:px-10 ","children":["$","div",null,{"className":"grid gap-10 lg:grid-cols-[1.45fr_1fr] lg:gap-16","children":[["$","div",null,{"children":[["$","div",null,{"className":"font-mono text-[0.65rem] uppercase tracking-[0.15em] text-ink-500","children":"Case study 05 · Consumer · 0 to 1 feature"}],["$","h1",null,{"className":"mt-5 max-w-[16ch] text-[clamp(2rem,5.2vw,3.9rem)] font-normal leading-[1.03] tracking-[-0.045em]","dangerouslySetInnerHTML":{"__html":"One-Tap <em style=\"font-style:normal;font-family:var(--font-editorial)\" class=\"text-accent\">Playlists</em>"}}],["$","p",null,{"className":"mt-6 max-w-[58ch] text-[1.02rem] leading-relaxed text-ink-200","dangerouslySetInnerHTML":{"__html":"I kept discovering songs I loved through autoplay, but the moment the session ended, I had no easy way to turn that discovery into a playlist."}}],["$","div",null,{"className":"mt-7 flex flex-wrap gap-2","children":[["$","span","JTBD",{"className":"rounded-full border border-ink-800 px-3 py-1 text-[0.7rem] text-ink-400","children":"JTBD"}],["$","span","Constrained LLM orchestration",{"className":"rounded-full border border-ink-800 px-3 py-1 text-[0.7rem] text-ink-400","children":"Constrained LLM orchestration"}],["$","span","Structured output contract",{"className":"rounded-full border border-ink-800 px-3 py-1 text-[0.7rem] text-ink-400","children":"Structured output contract"}],["$","span","A/B design",{"className":"rounded-full border border-ink-800 px-3 py-1 text-[0.7rem] text-ink-400","children":"A/B design"}],["$","span","Consumer 0 to 1",{"className":"rounded-full border border-ink-800 px-3 py-1 text-[0.7rem] text-ink-400","children":"Consumer 0 to 1"}]]}]]}],["$","dl",null,{"className":"grid content-start gap-5 self-end","children":[["$","div","Type",{"className":"border-t border-ink-800 pt-3","children":[["$","dt",null,{"className":"font-mono text-[0.6rem] uppercase tracking-[0.13em] text-ink-500","children":"Type"}],["$","dd",null,{"className":"mt-1.5 text-[0.88rem] text-ink-50","children":"Self-directed AI PM case study"}]]}],["$","div","Domain",{"className":"border-t border-ink-800 pt-3","children":[["$","dt",null,{"className":"font-mono text-[0.6rem] uppercase tracking-[0.13em] text-ink-500","children":"Domain"}],["$","dd",null,{"className":"mt-1.5 text-[0.88rem] text-ink-50","children":"Music streaming"}]]}],["$","div","Focus",{"className":"border-t border-ink-800 pt-3","children":[["$","dt",null,{"className":"font-mono text-[0.6rem] uppercase tracking-[0.13em] text-ink-500","children":"Focus"}],["$","dd",null,{"className":"mt-1.5 text-[0.88rem] text-ink-50","children":"Discovery to collection"}]]}],["$","div","Reading time",{"className":"border-t border-ink-800 pt-3","children":[["$","dt",null,{"className":"font-mono text-[0.6rem] uppercase tracking-[0.13em] text-ink-500","children":"Reading time"}],"$L10"]}]]}]]}]}]}],"$L11","$L12"]}]]
10:["$","dd",null,{"className":"mt-1.5 text-[0.88rem] text-ink-50","children":"~7 minutes"}]
13:T3bd4,<section id="problem">
